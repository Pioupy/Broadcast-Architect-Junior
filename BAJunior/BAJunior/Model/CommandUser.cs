...
namespace BAJunior.Model
{
    class CommandUser
    {
        ...
        //Default constructor
        public CommandUser(String name, String picture, int idCategory)
        {
            m_name = name;
            m_picture = picture;
        ...
        //Constructor with ID
        public CommandUser(int id, String name, String picture, int idCategory)
        {
            m_idCommandUser = id;
            m_name = name;
            m_picture = picture;
